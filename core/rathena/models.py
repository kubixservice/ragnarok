...
class CharWoeLog(models.Model):
    time = models.DateTimeField()
    killer = models.CharField(max_length=25)
    killer_id = models.ForeignKey(Char, on_delete=models.CASCADE, db_column='killer_id', related_name='killer')
    killed = models.CharField(max_length=25)
    killed_id = models.ForeignKey(Char, on_delete=models.CASCADE, db_column='killed_id', related_name='killed')
    map = models.CharField(max_length=11)
    skill = models.IntegerField()
